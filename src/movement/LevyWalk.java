 ...
 * @see <a href="https://ieeexplore.ieee.org/document/5750071">On the Levy-Walk
 *      Nature of Human Mobility</a>
 */
public class LevyWalk extends MovementModel {
	...
	/**
	 * Alpha value defines the slope parameter (flight lengths). Typically, between
	 * 1.0 and 3.0.
	 */
