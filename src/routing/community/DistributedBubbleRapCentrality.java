 ...
 *
 */
public class DistributedBubbleRapCentrality
	...
	public int[] getArrayCentrality() {
		// Return an array with global centrality and local centrality values
		int globalCent = (int) Math.round(this.getGlobalCentrality());
		int localCent = (int) Math.round(this.getLocalCentrality());

		return new int[] { globalCent, localCent };
	}
}